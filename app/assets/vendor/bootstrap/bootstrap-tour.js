...
(function ($, window) {
    ...
    Tour = (function () {
            ...
            this._options = $.extend(
                {
                    ...
                    basePath: "",
                    template:
                        "<div class='popover'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <div class='popover-content'></div>          <div class='popover-navigation'>            <div class='btn-group'>              <button class='btn btn-sm btn-default' data-role='prev'>&laquo; Prev</button>              <button class='btn btn-sm btn-default' data-role='next'>Next &raquo;</button>              <button class='btn btn-sm btn-default' data-role='pause-resume'                data-pause-text='Pause'                data-resume-text='Resume'              >Pause</button>            </div>            <button class='btn btn-sm btn-default' data-role='end'>End tour</button>          </div>        </div>",
            ...
            if (this._options.storage) {
                ...
                try {
                    ...
                    if (e.code === DOMException.QUOTA_EXCEEDED_ERR) {
                        this.debug(
                            "LocalStorage quota exceeded. setState failed."
                        );
                    }
                }
        ...
        Tour.prototype.hideStep = function (i) {
            ...
            this._clearTimer();
            promise = this._makePromise(
                step.onHide != null ? step.onHide(this, i) : void 0
            );
            hideStepHelper = function (e) {
                var $element;
                $element = $(step.element);
                if (
                    !($element.data("bs.popover") || $element.data("popover"))
                ) {
                    $element = $("body");
                }
                ...
                if (step.reflex) {
                    $element
                        .css("cursor", "")
                        .off("click.tour-" + _this._options.name);
                }
                if (step.backdrop) {
                    _this._hideBackdrop();
                }
        ...
        Tour.prototype.showStep = function (i) {
            ...
            promise = this._makePromise(
                step.onShow != null ? step.onShow(this, i) : void 0
            );
            showStepHelper = function (e) {
                var current_path, path;
                _this.setCurrentStep(i);
                path = $.isFunction(step.path)
                    ? step.path.call()
                    : _this._options.basePath + step.path;
                current_path = [
                ...
                if (step.backdrop) {
                    _this._showBackdrop(
                        !_this._isOrphan(step) ? step.element : void 0
                    );
                }
        ...
        Tour.prototype._showNextStep = function () {
            ...
            promise = this._makePromise(
                step.onNext != null ? step.onNext(this) : void 0
            );
        ...
        Tour.prototype._showPrevStep = function () {
            ...
            promise = this._makePromise(
                step.onPrev != null ? step.onPrev(this) : void 0
            );
        ...
        Tour.prototype._showPopover = function (step, i) {
            ...
            $template = $.isFunction(step.template)
                ? $(step.template(i, step))
                : $(step.template);
            ...
            if (step.reflex) {
                $element
                    .css("cursor", "pointer")
                    .on("click.tour-" + this._options.name, function () {
                        if (_this._isLast()) {
                            return _this.next();
                        } else {
                            return _this.end();
        ...
        Tour.prototype._reposition = function ($tip, step) {
            ...
            offsetRight =
                $("html").outerWidth() - tipOffset.left - $tip.outerWidth();
            if (offsetRight < 0) {
        ...
        Tour.prototype._center = function ($tip) {
            return $tip.css(
                "top",
                $(window).outerHeight() / 2 - $tip.outerHeight() / 2
            );
        };

        Tour.prototype._replaceArrow = function (
            $tip,
            delta,
            dimension,
            position
